  ...
  return (
    <section className="min-h-screen pt-16 grid grid-cols-1 lg:grid-cols-2 relative overflow-hidden">
      ...
      <div className="relative flex flex-col justify-center px-[7vw] py-20 overflow-hidden"
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/70 text-[14px] leading-relaxed max-w-md mb-7">
            From the heartland of Haryana to the hills of Lahaul Spiti, Uttarakhand and the landscapes of Ooty — India&apos;s trusted partner in agro-horticulture and floriculture since 2009.
          </p>
          <div className="inline-flex items-center gap-4 bg-white/7 border border-white/15 backdrop-blur-sm rounded-full px-5 py-3">
            ...
            <div className="text-[12px] text-white/65 leading-snug"><span className="text-white font-bold block">Est. Jind, Haryana</span>India&apos;s leading horti-flori solution provider</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-cream grid grid-rows-[1fr_auto]">
        <div className="bg-gradient-to-br from-magenta-pale to-orange-50 flex items-center justify-center text-[9rem] border-b border-magenta/10">
          🌸
        </div>
